 ...
 */
export const addEventListener = (eventName: any, handler: any, el: any) => {
 ...
 */
export const addEventListeners = (listeners: any = {}, el: any) => {
 ...
 */
export const removeEventListeners = (listeners: any = {}, el: any) => {
    Object.entries(listeners).forEach(([eventName, handler]) => {
