/**
 * Creates a reducer function that handles the game state
 * transitions. And checks for the winner.
 * 
 * @param {object} state 
 * @param {number} row 
 * @param {number} col
 * @returns {object}
 */
export default function markReducer(state, { row, col }) {
    // Checks if the move is within a 3 x 3 grid boundary
